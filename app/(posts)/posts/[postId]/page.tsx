...
const PostsIdPage = async ({ params }: { params: { postId: number } }) => {
  ...
  return (
    <div className="text-stone-700 flex items-center flex-col mt-10 px-5">
      <h1 className="font-bold text-3xl uppercase">
        posts for {params.postId}
      </h1>

      <div className="md:w-[40rem] w-full space-y-3 text-left mt-10 p-5 border border-stone-400">
